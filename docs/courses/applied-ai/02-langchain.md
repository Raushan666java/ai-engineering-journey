...
<a href="../../../assets/images/lessons/applied-ai/02-langchain/hero.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/applied-ai/02-langchain/hero.svg" alt="Chapter Banner: Chapter 2: LangChain & LLM Orchestration" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/applied-ai/02-langchain/handwritten-notes.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/applied-ai/02-langchain/handwritten-notes.svg" alt="Handwritten Notes: Chapter 2: LangChain & LLM Orchestration" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/applied-ai/02-langchain/sticky-notes.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/applied-ai/02-langchain/sticky-notes.svg" alt="Sticky Notes: Chapter 2: LangChain & LLM Orchestration" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/applied-ai/02-langchain/visual-explanation.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/applied-ai/02-langchain/visual-explanation.svg" alt="Visual Explanation: Chapter 2: LangChain & LLM Orchestration" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/applied-ai/02-langchain/architecture.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/applied-ai/02-langchain/architecture.svg" alt="Architecture: Chapter 2: LangChain & LLM Orchestration" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/applied-ai/02-langchain/workflow.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/applied-ai/02-langchain/workflow.svg" alt="Workflow: Chapter 2: LangChain & LLM Orchestration" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/applied-ai/02-langchain/mindmap.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/applied-ai/02-langchain/mindmap.svg" alt="Mind Map: Chapter 2: LangChain & LLM Orchestration" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/applied-ai/02-langchain/comparison.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/applied-ai/02-langchain/comparison.svg" alt="Comparison: Chapter 2: LangChain & LLM Orchestration" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/applied-ai/02-langchain/cheatsheet.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/applied-ai/02-langchain/cheatsheet.svg" alt="Cheat Sheet: Chapter 2: LangChain & LLM Orchestration" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/applied-ai/02-langchain/interview-quiz.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/applied-ai/02-langchain/interview-quiz.svg" alt="Quiz Card: Chapter 2: LangChain & LLM Orchestration" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/applied-ai/02-langchain/social-card.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/applied-ai/02-langchain/social-card.svg" alt="Social Card: Chapter 2: LangChain & LLM Orchestration" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
</div>
<!-- End Image Gallery -->
