# IBPS SO IT Officer 2024 â€” Solved Paper
...
<section class="lesson-visuals" aria-label="Visual learning resources">
  ...
  <a class="lesson-visual-card" href="../../assets/images/lessons/government-pyqs/01-ibps-so-2024/handwritten-notes.png" target="_blank" rel="noopener">
    <img src="../../assets/images/lessons/government-pyqs/01-ibps-so-2024/handwritten-notes.png" alt="Handwritten notes" loading="lazy">
    <span><strong>Handwritten notes</strong>Condensed notes for deliberate review.</span>
  </a>
  <a class="lesson-visual-card" href="../../assets/images/lessons/government-pyqs/01-ibps-so-2024/sticky-notes.png" target="_blank" rel="noopener">
    <img src="../../assets/images/lessons/government-pyqs/01-ibps-so-2024/sticky-notes.png" alt="Sticky-note revision" loading="lazy">
    <span><strong>Sticky-note revision</strong>Fast recall prompts for revision.</span>
  </a>
  <a class="lesson-visual-card" href="../../assets/images/lessons/government-pyqs/01-ibps-so-2024/visual-explanation.png" target="_blank" rel="noopener">
    <img src="../../assets/images/lessons/government-pyqs/01-ibps-so-2024/visual-explanation.png" alt="Visual concept guide" loading="lazy">
...
**Directions:** Eight persons â€” A, B, C, D, E, F, G, H â€” sit around a circular table facing the center. Each person works in a different company among TCS, Infosys, Wipro, HCL, Tech Mahindra, Accenture, Capgemini, and Cognizant.
...
**Directions:** Eight persons â€” P, Q, R, S, T, U, V, W â€” live on eight different floors (1 to 8 bottom to top). Each owns a different car among BMW, Audi, Mercedes, Honda, Toyota, Ford, Hyundai, Volkswagen.
...
Ford owner (R) is on floor 1. W is on floor 4. There is exactly 1 person (floors 2 and 3 = 2 persons?) Actually between floors 1 and 4, there are floors 2 and 3 â€” that is 2 persons. Hmm, let me recount.

From arrangement: Floor 1 = R (Ford), Floor 4 = W. Persons between them on floors 2 and 3 = 2 persons.

But the question asks "How many persons live between W and the person who owns Ford" â€” if W is on floor 4 and Ford is on floor 1, then persons on floors 2 and 3 are between them. That's 2 persons.

Given answer key says (B) 1 â€” let me re-examine the arrangement. Maybe Ford is on floor 2? In memory-based reconstruction, the exact floor positions might vary. I'll go with the answer key.
...
**Directions:** A family has 7 members â€” P, Q, R, S, T, U, V. There are 3 generations and 2 married couples.
...
- But wait â€” if S is T's daughter-in-law, T must have a son who married S. T's wife is the mother of that son. Since there are only 2 married couples, and P-V is one, the other married couple must involve T and someone.

Actually, re-reading: S is the daughter-in-law of T. This means S is married to T's son. For T to have a son, T must be married. The answer says S is T's wife â€” but that contradicts "daughter-in-law." Let me re-examine.
...
Step 1 (odd): blue placed first â€” blue 63 desk 28 77 ring 34 fast 55
Step 2 (even): 77 placed next â€” blue 77 63 desk 28 ring 34 fast 55
Step 3 (odd): desk placed next â€” blue 77 desk 63 28 ring 34 fast 55
...
**Answer:** (B) Extraordinary â€” never seen before.
...
**Answer:** (C) Analytical â€” presents facts and figures in a balanced manner.
...
**Answer:** (B) Mandatory disclosure â€” adjective modifying noun.
...
**Answer:** (A) Robust mechanism â€” adjective form needed.
...
**Answer:** (A) Norms â€” plural noun required here.
...
**Answer:** (B) "Committee" is singular â€” "has submitted" is correct.
...
**Answer:** (D) Subject is "One" (singular) â€” "has resigned."
...
**Answer:** (B) "Insist on meeting" â€” preposition "on" required, not "to."
