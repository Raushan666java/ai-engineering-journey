...
<a href="../../../assets/images/lessons/operating-systems/07-deadlocks/hero.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/operating-systems/07-deadlocks/hero.svg" alt="Chapter Banner: Chapter 7: Deadlocks" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/operating-systems/07-deadlocks/handwritten-notes.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/operating-systems/07-deadlocks/handwritten-notes.svg" alt="Handwritten Notes: Chapter 7: Deadlocks" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/operating-systems/07-deadlocks/sticky-notes.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/operating-systems/07-deadlocks/sticky-notes.svg" alt="Sticky Notes: Chapter 7: Deadlocks" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/operating-systems/07-deadlocks/visual-explanation.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/operating-systems/07-deadlocks/visual-explanation.svg" alt="Visual Explanation: Chapter 7: Deadlocks" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/operating-systems/07-deadlocks/architecture.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/operating-systems/07-deadlocks/architecture.svg" alt="Architecture: Chapter 7: Deadlocks" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/operating-systems/07-deadlocks/workflow.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/operating-systems/07-deadlocks/workflow.svg" alt="Workflow: Chapter 7: Deadlocks" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/operating-systems/07-deadlocks/mindmap.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/operating-systems/07-deadlocks/mindmap.svg" alt="Mind Map: Chapter 7: Deadlocks" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/operating-systems/07-deadlocks/comparison.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/operating-systems/07-deadlocks/comparison.svg" alt="Comparison: Chapter 7: Deadlocks" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/operating-systems/07-deadlocks/cheatsheet.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/operating-systems/07-deadlocks/cheatsheet.svg" alt="Cheat Sheet: Chapter 7: Deadlocks" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/operating-systems/07-deadlocks/interview-quiz.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/operating-systems/07-deadlocks/interview-quiz.svg" alt="Quiz Card: Chapter 7: Deadlocks" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/operating-systems/07-deadlocks/social-card.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/operating-systems/07-deadlocks/social-card.svg" alt="Social Card: Chapter 7: Deadlocks" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
</div>
<!-- End Image Gallery -->
...
- **Request edge** (Páµ¢ → Râ±¼): process i wants resource j
- **Assignment edge** (Râ±¼ → Páµ¢): resource j is allocated to process i

#### RAG Construction Rules

1. When process Páµ¢ requests resource Râ±¼: add a request edge Páµ¢ → Râ±¼
2. When the request is granted: convert to assignment edge Râ±¼ → Páµ¢
...
FUNCTION isDeadlock(RAG):
    REPEAT:
        ...
        (for each request edge Páµ¢ → Râ±¼, there is a free instance of Râ±¼)
        IF found:
...
Check:
- P0 needs R2Ã—1 but R2=0 available → blocked
- P1 needs R1Ã—1 but R1=0 available → blocked
- P2 needs R1Ã—1 but R1=0 available → blocked
...
Available[m]:     Available[j] = k → k instances of Râ±¼ are free
Max[n][m]:        Max[i][j] = k → Páµ¢ will need at most k instances of Râ±¼
Allocation[n][m]: Allocation[i][j] = k → Páµ¢ currently holds k instances
Need[n][m]:       Need[i][j] = Max[i][j] - Allocation[i][j]
Request[i][m]:    Request[i][j] = k → Páµ¢ is requesting k instances of Râ±¼
...
Iteration 1:
  ...
  P1: Need=[1,2,2] â‰¤ Available=[3,3,2] → CAN RUN âœ“
  Execute P1:
...
Iteration 2:
  ...
  P3: Need=[0,1,1] â‰¤ Work=[5,3,2] → CAN RUN âœ“
  Execute P3:
    Work = [5,3,2] + Allocation[3]=[2,1,1] = [7,4,3]
    Finish[3] = true

Iteration 3:
  P0: Need=[7,4,3] â‰¤ Work=[7,4,3] → CAN RUN âœ“
  Execute P0:
    Work = [7,4,3] + Allocation[0]=[0,1,0] = [7,5,3]
    Finish[0] = true

Iteration 4:
  P2: Need=[6,0,0] â‰¤ Work=[7,5,3] → CAN RUN âœ“
  Execute P2:
    Work = [7,5,3] + Allocation[2]=[3,0,2] = [10,5,5]
    Finish[2] = true

Iteration 5:
  P4: Need=[4,3,1] â‰¤ Work=[10,5,5] → CAN RUN âœ“
  Execute P4:
...
Check 1: Request â‰¤ Need[1]? [1,0,2] â‰¤ [1,2,2] → Yes âœ“
Check 2: Request â‰¤ Available? [1,0,2] â‰¤ [3,3,2] → Yes âœ“
...
Iteration 1:
  P0: [7,4,3] > [2,3,0] → No
  P1: [0,2,0] â‰¤ [2,3,0] → YES → Work = [5,3,2], Finish[1]=true
  (check P2, P3, P4: none can run yet)

Iteration 2:
  P0: [7,4,3] > [5,3,2] → No
  P3: [0,1,1] â‰¤ [5,3,2] → YES → Work = [7,4,3], Finish[3]=true

Iteration 3:
  P0: [7,4,3] â‰¤ [7,4,3] → YES → Work = [7,5,3], Finish[0]=true

Iteration 4:
  P2: [6,0,0] â‰¤ [7,5,3] → YES → Work = [10,5,5], Finish[2]=true

Iteration 5:
  P4: [4,3,1] â‰¤ [10,5,5] → YES → Work = [10,5,7], Finish[4]=true
...
Check 1: Request â‰¤ Need[4]? [3,3,0] â‰¤ [4,3,1] → Yes âœ“
Check 2: Request â‰¤ Available? [3,3,0] â‰¤ [2,3,0] → No → Request DENIED
(P4 must wait)
```
...
Check 1: Request â‰¤ Need[0]? [0,2,0] â‰¤ [7,4,3] → Yes âœ“
Check 2: Request â‰¤ Available? [0,2,0] â‰¤ [2,3,0] → Yes âœ“
...
public:
    ...
    bool requestResources(int pid, const vector<int>& request) {
        ...
        vector<int> safeSeq;
        if (isSafe(safeSeq)) {
            cout << "Step 4: State is SAFE → Request GRANTED âœ“\n";
            return true;
        } else {
            // Rollback
            for (int j = 0; j < m; j++) {
            ...
            cout << "Step 4: State is UNSAFE → Request DENIED âœ—\n";
            return false;
        }
    }
    ...
    def request_resources(self, pid: int, request: list) -> bool:
        ...
        for j in range(self.m):
            if request[j] > self.available[j]:
                print("Step 2 âœ—: Request > Available → must wait")
                return False
        ...
        if safe:
            print(f"Step 4 âœ“: SAFE → Request GRANTED. Sequence: {seq}")
            return True
        else:
            # Rollback
            for j in range(self.m):
                ...
                self.allocation[pid][j] -= request[j]
                self.need[pid][j] += request[j]
            print("Step 4 âœ—: UNSAFE → Request DENIED, rolled back")
            return False
...
Step 4 âœ“: SAFE → Request GRANTED. Sequence: [1, 3, 0, 2, 4]
```
...
With n=5, m=3: 5 Ã— 5 Ã— 3 = 75 operations → trivial
With n=100, m=10: 100 Ã— 100 Ã— 10 = 100,000 operations → still reasonable
```
...
Safety check:
  P0: Need=[1,1] â‰¤ Work=[1,1] → run → Work=[2,1]
  P1: Need=[1,1] â‰¤ Work=[2,1] → run → Work=[2,2]
  SAFE
...
Initial Finish:
  P0: Allocation=[0,1,0] â‰  zero → Finish[0]=false
  P1: Allocation=[2,0,0] â‰  zero → Finish[1]=false
  P2: Allocation=[3,0,2] â‰  zero → Finish[2]=false
  P3: Allocation=[2,1,1] â‰  zero → Finish[3]=false
  P4: Allocation=[0,0,2] â‰  zero → Finish[4]=false
...
```
// Probe format: (i, j, k) → initiated by Páµ¢, sent from Pâ±¼ to Pâ‚–
// Pâ±¼ waits for Pâ‚– (Pâ±¼ → Pâ‚– in wait-for graph)
...
UPON receiving probe (i, j, k):
    ...
    IF Pâ‚– is blocked:
        ...
        ELSE:
            ...
            send_probe(i, k, next) for each blocked Pâ‚– → next
    ELSE:
        // Pâ‚– is not blocked → discard probe
        RETURN
```
