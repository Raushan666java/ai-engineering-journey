...
**Easy** — Write a custom Dataset class for CSV data. Implement __len__ and __getitem__ to return feature tensors and labels.
...
> **Previous**: [07-rnn-and-lstm.md](07-rnn-and-lstm.md) | **Next**: [09-model-deployment.md](09-model-deployment.md)
