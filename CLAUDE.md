...
- **Python Programming (21 ch):** Expanded all 21 chapters from 414-780 to 531-682 lines (avg 593). Added TypeScript code blocks before every "## Summary" section — variables, control flow, loops, strings, arrays/lists, tuples/sets, dictionaries, functions, lambdas, modules, OOP, inheritance, magic methods, decorators, generators, exceptions/files, stdlib, APIs/testing, NumPy/pandas, and concurrency patterns. Every chapter now includes parallel TypeScript implementations demonstrating the same concepts.
