...
slug: /geeta-darshan/07-jnana-vijnana-yoga
title: "अध्याय ७: ज्ञान विज्ञान योग — Maya koi illusion nahin, bhool hai"
sidebar_label: "अध्याय ७: ज्ञान विज्ञान योग — Maya koi illusion nahin, bhool hai"
sidebar_position: 8
---
...
```mermaid
flowchart TB
    A["Tum aaj kahan ho; sawaal yeh hai"] --> B{"Drishti kaise hai?"}
    B -->|"Dukh mein chubhti hui"| C["Arta; dukh ka jhatka"]
    B -->|"Sawaal uthate hue"| D["Jijnasu; khoj ka dwar"]
    B -->|"Labh dhoondhti hui"| E["Artharthi; upar ki drishti"]
    B -->|"Anubav se jaanti hui"| F["Jnani; pooja khatam"]
    C --> G["Seedhi ka ek-ek daana; koi galti nahin"]
    D --> G
    E --> G
    F --> G
    G --> H["Maya; sirf drishti ki bhool"]
    H --> I["Sakshi; jo dekhta hai woh hi asli"]
    I --> J["Vijnana; suna nahin, anubav kiya"]
    style I fill:#4446e8,color:#fff
    style J fill:#1a1b23,color:#fff
```
