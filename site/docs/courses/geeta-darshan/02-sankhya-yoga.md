---
id: 02-sankhya-yoga
slug: /geeta-darshan/02-sankhya-yoga
title: "अध्याय २: सांख्य योग — Jagrukta hi asli gyan hai"
sidebar_label: "अध्याय २: सांख्य योग — Jagrukta hi asli gyan hai"
sidebar_position: 3
---
...
```mermaid
flowchart TB
    A["Arjuna ka vishad; dhanush gira"] --> B["Krishna ka pehla jawab; chunauti"]
    B --> C["Ashochyan: roone ka bhram hatana"]
    C --> D["Atma ka gyan: na janm na mrityu"]
    D --> E["Karm ka gyan: karmanyevadhikaraste"]
    E --> F["Stithaprajna ka lakshan"]
    F --> G["Man ka chain: dhyana se patan tak"]
    G --> H["Samudra ka drishtant: poornata"]
    H --> I["Jagrukta; sakshi; sthita buddhi"]
