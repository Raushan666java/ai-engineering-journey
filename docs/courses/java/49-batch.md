...
<a href="../../../assets/images/lessons/java/49-batch/hero.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/java/49-batch/hero.svg" alt="Chapter Banner: Spring Batch" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/java/49-batch/handwritten-notes.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/java/49-batch/handwritten-notes.svg" alt="Handwritten Notes: Spring Batch" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/java/49-batch/sticky-notes.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/java/49-batch/sticky-notes.svg" alt="Sticky Notes: Spring Batch" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/java/49-batch/visual-explanation.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/java/49-batch/visual-explanation.svg" alt="Visual Explanation: Spring Batch" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/java/49-batch/architecture.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/java/49-batch/architecture.svg" alt="Architecture: Spring Batch" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/java/49-batch/workflow.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/java/49-batch/workflow.svg" alt="Workflow: Spring Batch" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/java/49-batch/mindmap.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/java/49-batch/mindmap.svg" alt="Mind Map: Spring Batch" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/java/49-batch/comparison.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/java/49-batch/comparison.svg" alt="Comparison: Spring Batch" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/java/49-batch/cheatsheet.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/java/49-batch/cheatsheet.svg" alt="Cheat Sheet: Spring Batch" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/java/49-batch/interview-quiz.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/java/49-batch/interview-quiz.svg" alt="Quiz Card: Spring Batch" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/java/49-batch/social-card.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/java/49-batch/social-card.svg" alt="Social Card: Spring Batch" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
</div>
<!-- End Image Gallery -->
