...
| 4 | `getline(in, line)` â€” call 3 | good=true | `"Line 3: Pi â‰ˆ 3.14159"` | `Read: Line 3: Pi â‰ˆ 3.14159` |
...
| `ios::app` | Append | Always write at the end; file created if it doesn't exist | âŒ No | â€” | â€” |
| `ios::ate` | At End | Seek to end immediately after opening | âŒ No | â€” | â€” |
