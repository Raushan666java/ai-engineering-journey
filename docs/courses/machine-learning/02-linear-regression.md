...
<a href="../../../assets/images/lessons/machine-learning/02-linear-regression/hero.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/machine-learning/02-linear-regression/hero.svg" alt="Chapter Banner: Chapter 2: Linear Regression" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/machine-learning/02-linear-regression/handwritten-notes.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/machine-learning/02-linear-regression/handwritten-notes.svg" alt="Handwritten Notes: Chapter 2: Linear Regression" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/machine-learning/02-linear-regression/sticky-notes.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/machine-learning/02-linear-regression/sticky-notes.svg" alt="Sticky Notes: Chapter 2: Linear Regression" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/machine-learning/02-linear-regression/visual-explanation.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/machine-learning/02-linear-regression/visual-explanation.svg" alt="Visual Explanation: Chapter 2: Linear Regression" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/machine-learning/02-linear-regression/architecture.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/machine-learning/02-linear-regression/architecture.svg" alt="Architecture: Chapter 2: Linear Regression" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/machine-learning/02-linear-regression/workflow.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/machine-learning/02-linear-regression/workflow.svg" alt="Workflow: Chapter 2: Linear Regression" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/machine-learning/02-linear-regression/mindmap.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/machine-learning/02-linear-regression/mindmap.svg" alt="Mind Map: Chapter 2: Linear Regression" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/machine-learning/02-linear-regression/comparison.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/machine-learning/02-linear-regression/comparison.svg" alt="Comparison: Chapter 2: Linear Regression" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/machine-learning/02-linear-regression/cheatsheet.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/machine-learning/02-linear-regression/cheatsheet.svg" alt="Cheat Sheet: Chapter 2: Linear Regression" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/machine-learning/02-linear-regression/interview-quiz.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/machine-learning/02-linear-regression/interview-quiz.svg" alt="Quiz Card: Chapter 2: Linear Regression" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/machine-learning/02-linear-regression/social-card.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/machine-learning/02-linear-regression/social-card.svg" alt="Social Card: Chapter 2: Linear Regression" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
</div>
<!-- End Image Gallery -->
