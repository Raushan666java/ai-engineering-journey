...
slug: /geeta-darshan/14-gunatraya-vibhaga-yoga
title: "अध्याय १४: गुणत्रय विभाग योग — \"Teen gunas — tumhari psychology ka map\""
sidebar_label: "अध्याय १४: गुणत्रय विभाग योग — \"Teen gunas — tumhari psychology ka map\""
sidebar_position: 15
---
...
```mermaid
flowchart TB
  subgraph GUNAS["TEEN GUNAS"]
    S["Sattva: prakash aur nirmalta"] --> S1["Bandhan: sukh ka sang"]
    S --> S2["Bandhan: jnana ka sang"]
    R["Rajas: rag aur trishna"] --> R1["Bandhan: karma ka sang"]
    T["Tamas: ajnana aur moh"] --> T1["Bandhan: pramad aalsya nidra"]
  end
  subgraph WITNESS["GUNATITA"]
    W["Sakshi: guna vartante iti"]
    W1["Tulya ninda aur stuti"]
    W2["Sama dukh sukh"]
  end
  S1 --> C["Pehchan ka bandhan"]
  S2 --> C
  R1 --> C
  T1 --> C
  C --> C1["Dukh aur punarjanm"]
  W --> W1
  W1 --> W2
  W2 --> F["Brahma bhava"]
  C -.->|"dekhna hi rasta"| W
