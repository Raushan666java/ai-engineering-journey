# IBPS SO IT Officer 2021 â€” Solved Paper
...
**Directions:** Eight persons â€” A, B, C, D, E, F, G, H â€” sit around a circular table facing the center. Each belongs to a different city among Mumbai, Delhi, Kolkata, Chennai, Bengaluru, Hyderabad, Pune, Ahmedabad (not necessarily in same order).
...
**Directions:** Seven persons â€” P, Q, R, S, T, U, V â€” attend seminars on different days from Monday to Sunday (not necessarily in same order). Each likes a different subject among English, Maths, Science, History, Geography, Physics, Chemistry.
...
If English on Friday, P on Monday... wait, "3 days before" â€” English on day X, P on day X+3. Mon-Thu, Tue-Fri, Wed-Sat, Thu-Sun.
...
Let me try: English on Wednesday (V), P on Saturday (T). But T is given as Saturday. So if P is T, then P=T is on Saturday. And T attends Saturday. So P on Saturday, T on Saturday â€” same person. This works if P=T.

Wait, the problem says "Seven persons â€” P, Q, R, S, T, U, V." They are distinct persons. P and T are different. So P can't be on Saturday if T is on Saturday.
...
One person between Chemistry and Maths. If P is Maths (Monday), then Chemistry is 2 days away: Wed or... P Monday, Chemistry on Wednesday (one between â€” Tue). So Chemistry on Wed.
...
**Answer:** (C) Both are strong â€” both sides represent valid concerns.
...
**Answer:** (C) Both â€” a bonus implies profits, and companies expect motivation from bonuses.
...
**Answer:** (A) been. "Has been" â€” present perfect.
...
**Answer:** (D) adapting. "Quickly adapting to remote work" â€” gerund after "quickly."
...
**Answer:** (B) increased. "Has increased significantly" â€” past participle.
...
**Answer:** (D) robust. "Robust hiring" â€” adjective modifying noun.
...
**Answer:** (C) "Were" â€” verb agrees with nearest subject "board members" (plural).
...
**Answer:** (B) "Has" â€” "Each" is singular.
...
**Answer:** (B) "Has" â€” "Committee" is a collective noun acting as a unit.
...
**Answer:** (B) 200 OK â€” the request was successful.
...
**Answer:** (A) O(1) â€” direct access via index.
...
**Answer:** (A) HTTP is a stateless protocol â€” it does not maintain state between requests.
...
**Answer:** (C) RAM is volatile â€” data is lost when power is turned off.
...
| **English** | Passages on digital banking and online education â€” current affairs based |
