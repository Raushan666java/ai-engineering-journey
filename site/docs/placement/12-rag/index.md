...
Build retrieval-augmented generation systems using vector databases, embeddings, hybrid search, and re-ranking. Covers chunking strategies, evaluation, and production-ready RAG patterns.
...
[LLMs & Prompt Engineering](/11-llms-prompt/index.md). Experience with LLM APIs and embedding concepts is recommended.
