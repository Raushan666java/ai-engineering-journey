...
**Easy** — Use a pretrained ResNet-18 from torchvision to create a feature extractor for a 5-class dataset. Train only the classifier head and report accuracy.
...
> **Previous**: [05-advanced-cnn.md](05-advanced-cnn.md) | **Next**: [07-rnn-and-lstm.md](07-rnn-and-lstm.md)
