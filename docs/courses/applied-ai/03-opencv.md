...
<a href="../../../assets/images/lessons/applied-ai/03-opencv/hero.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/applied-ai/03-opencv/hero.svg" alt="Chapter Banner: Chapter 3: OpenCV & Computer Vision" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/applied-ai/03-opencv/handwritten-notes.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/applied-ai/03-opencv/handwritten-notes.svg" alt="Handwritten Notes: Chapter 3: OpenCV & Computer Vision" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/applied-ai/03-opencv/sticky-notes.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/applied-ai/03-opencv/sticky-notes.svg" alt="Sticky Notes: Chapter 3: OpenCV & Computer Vision" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/applied-ai/03-opencv/visual-explanation.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/applied-ai/03-opencv/visual-explanation.svg" alt="Visual Explanation: Chapter 3: OpenCV & Computer Vision" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/applied-ai/03-opencv/architecture.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/applied-ai/03-opencv/architecture.svg" alt="Architecture: Chapter 3: OpenCV & Computer Vision" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/applied-ai/03-opencv/workflow.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/applied-ai/03-opencv/workflow.svg" alt="Workflow: Chapter 3: OpenCV & Computer Vision" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/applied-ai/03-opencv/mindmap.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/applied-ai/03-opencv/mindmap.svg" alt="Mind Map: Chapter 3: OpenCV & Computer Vision" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/applied-ai/03-opencv/comparison.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/applied-ai/03-opencv/comparison.svg" alt="Comparison: Chapter 3: OpenCV & Computer Vision" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/applied-ai/03-opencv/cheatsheet.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/applied-ai/03-opencv/cheatsheet.svg" alt="Cheat Sheet: Chapter 3: OpenCV & Computer Vision" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/applied-ai/03-opencv/interview-quiz.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/applied-ai/03-opencv/interview-quiz.svg" alt="Quiz Card: Chapter 3: OpenCV & Computer Vision" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/applied-ai/03-opencv/social-card.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/applied-ai/03-opencv/social-card.svg" alt="Social Card: Chapter 3: OpenCV & Computer Vision" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
</div>
<!-- End Image Gallery -->
