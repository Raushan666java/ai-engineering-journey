# PowerShell runner for Day 35 Binary Search & Search patterns
Set-StrictMode -Version Latest
$ErrorActionPreference = 'Stop'
Write-Host "Compiling Day 35 Java files..."
...
Write-Host "Day 35 demo run completed. Outputs and compile logs are in this folder."