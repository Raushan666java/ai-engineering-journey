  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_components.header, {
      ...
      children: ["\n  ", (0,jsx_runtime.jsxs)(_components.header, {
        ...
        href: "../../assets/images/lessons/ai-agent-engineer/04-phase3-agents-langgraph-mcp/handwritten-notes.png",
        target: "_blank",
        rel: "noopener",
        children: ["\n    ", (0,jsx_runtime.jsx)(_components.img, {
          src: "../../assets/images/lessons/ai-agent-engineer/04-phase3-agents-langgraph-mcp/handwritten-notes.png",
        ...
        className: "lesson-visual-card",
        href: "../../assets/images/lessons/ai-agent-engineer/04-phase3-agents-langgraph-mcp/sticky-notes.png",
        target: "_blank",
        rel: "noopener",
        children: ["\n    ", (0,jsx_runtime.jsx)(_components.img, {
          src: "../../assets/images/lessons/ai-agent-engineer/04-phase3-agents-langgraph-mcp/sticky-notes.png",
        ...
        className: "lesson-visual-card",
        href: "../../assets/images/lessons/ai-agent-engineer/04-phase3-agents-langgraph-mcp/visual-explanation.png",
        target: "_blank",
        rel: "noopener",
        children: ["\n    ", (0,jsx_runtime.jsx)(_components.img, {
          src: "../../assets/images/lessons/ai-agent-engineer/04-phase3-agents-langgraph-mcp/visual-explanation.png",
      ...
      children: ["interface PromptTemplate { name: string; template: string; variables: string[]; version: string }\nclass PromptEngine {\nprivate templates: Map<string,PromptTemplate> = new Map()\nregister(t: PromptTemplate): void { this.templates.set(t.name, t) }\nrender(name: string, vars: Record<string,string>): string {\nconst t = this.templates.get(name); if(!t) throw new Error(", (0,jsx_runtime.jsx)(_components.code, {
        children: "Template ${name} not found"
      }), ")\nlet result = t.template\nfor(const v of t.variables) { if(vars[v] === undefined) throw new Error(", (0,jsx_runtime.jsx)(_components.code, {
        children: "Variable ${v} not provided"
      }), "); result = result.replace(", (0,jsx_runtime.jsx)(_components.code, {
        children: "{{${v}}}"
      }), ", vars[v]) }\nreturn result\n}\nlistVersions(): string[] { return Array.from(this.templates.values()).map(t => ", (0,jsx_runtime.jsx)(_components.code, {
        children: "${t.name}@${t.version}"
      }), ") }\ndiff(t1: string, t2: string): string { const a = t1.split(\"\\n\"), b = t2.split(\"\\n\")\nconst changes: string[] = []; const max = Math.max(a.length,b.length)\nfor(let i=0;i<max;i++) if(a[i] !== b[i]) changes.push(", (0,jsx_runtime.jsx)(_components.code, {
        children: "L${i+1}: ${a[i]??\"\"} | ${b[i]??\"\"}"
