...
<section class="lesson-visuals" aria-label="Visual learning resources">
  ...
  <a class="lesson-visual-card" href="../../assets/images/lessons/placement-preparation/04-company-specific/handwritten-notes.png" target="_blank" rel="noopener">
    <img src="../../assets/images/lessons/placement-preparation/04-company-specific/handwritten-notes.png" alt="Handwritten notes" loading="lazy">
    <span><strong>Handwritten notes</strong>Condensed notes for deliberate review.</span>
  </a>
  <a class="lesson-visual-card" href="../../assets/images/lessons/placement-preparation/04-company-specific/sticky-notes.png" target="_blank" rel="noopener">
    <img src="../../assets/images/lessons/placement-preparation/04-company-specific/sticky-notes.png" alt="Sticky-note revision" loading="lazy">
    <span><strong>Sticky-note revision</strong>Fast recall prompts for revision.</span>
  </a>
  <a class="lesson-visual-card" href="../../assets/images/lessons/placement-preparation/04-company-specific/visual-explanation.png" target="_blank" rel="noopener">
    <img src="../../assets/images/lessons/placement-preparation/04-company-specific/visual-explanation.png" alt="Visual concept guide" loading="lazy">
...
|-------|-------------|-------------------|
| FAANG / MANGA | Highest bar â€” LeetCode Hard, system design, behavioral STAR | Practice 150+ problems; prepare CRACK approach for Google, LPs for Amazon |
...
| Semiconductor & Enterprise | Deep domain â€” C/C++, OS architecture, embedded systems | Study low-level coding, CUDA (NVIDIA), wireless protocols (Qualcomm) |
...
> **One-Sentence Takeaway:** FAANG/MANGA interviews test DSA depth, system design, and behavioral alignment (LPs at Amazon, Googleyness at Google, culture at Netflix) â€” tailor preparation to each company's specific framework.
>
> **Warning:** Do not memorize STAR answers â€” interviewers at Amazon and Google are trained to probe for rehearsed responses. Know your stories but deliver them conversationally.
...
> **One-Sentence Takeaway:** Product-based Indian companies (Flipkart, Uber, Swiggy, etc.) pay 15-60 LPA but require strong DSA, machine coding (especially Flipkart), and product-sense interviews â€” prepare for real-world system constraints not just textbook algorithms.

> **Pro Tip:** Flipkart's machine coding round is unique â€” build a working mini-app in 90 minutes (Grin, BookMyShow, Parking Lot). Practice this separately from LeetCode; it tests production thinking, not algorithmic tricks.
...
Answer: 30
Pattern: 1Ãƒâ€”2, 2Ãƒâ€”3, 3Ãƒâ€”4, 4Ãƒâ€”5, 5Ãƒâ€”6, 6Ãƒâ€”7
Or: +4, +6, +8, +10, +12
```
...
Solution: B's efficiency = 1.5 Ãƒâ€” A's efficiency
...
> **One-Sentence Takeaway:** Service-based companies (TCS, Infosys, Wipro) offer lower pay (3.5-12 LPA) and hire in bulk via aptitude + basic coding + CS fundamentals â€” the critical gate is the initial resume screening and online assessment, not the technical interview depth.
...
> **One-Sentence Takeaway:** Startups value versatility, ownership, and speed over algorithmic depth â€” build real full-stack projects, develop product sense, and prepare to wear many hats from day one.

> **Pro Tip:** At startups, ownership is the single most valued trait. In interviews, emphasize times you took initiative beyond your job description â€” built something unasked, fixed a systemic issue, or mentored without being told.
...
- **Compensation** â†’ Ã¢â€šÂ¹25-60 LPA for software roles; competitive with FAANG for senior positions
...
> **One-Sentence Takeaway:** Semiconductor & enterprise companies (NVIDIA, Qualcomm, Apple, Adobe) test deep domain knowledge â€” CUDA/architecture for chip firms, enterprise-scale architecture for software giants â€” and prioritize craft over LeetCode speed.
...
|-------------|-------------------|-----------------|---------------------|
| FAANG / MANGA | 25-60+ LPA (3-8 yr) | Hard DSA, System Design, BEH | LeetCode 150+ â†’ System Design â†’ Behavioral |
| Product-Based India | 15-60 LPA | Med/Hard DSA, Machine Coding, Product | DSA 100+ â†’ Machine Coding â†’ Product Sense |
| Service-Based | 3.5-12 LPA | Aptitude, Basic Coding, CS Fundas | Aptitude â†’ CS Fundamentals â†’ Easy LeetCode 40+ |
| Startups & Unicorns | 10-30 LPA + ESOPs | Full-Stack, Ownership, Communication | Portfolio â†’ Problem Solving â†’ Domain Research |
| Semiconductor & Enterprise | 20-45 LPA | C/C++, OS, Embedded, Domain Depth | Domain Knowledge â†’ Low-Level Coding â†’ Architecture |
...
1. Which company is known for having a dedicated "Bar Raiser" interview round?
   ...
   - C) Flipkart
   - D) TCS
   <details><summary>Answer&lt;/summary&gt;**B)** Amazon â€” the Bar Raiser is an independent interviewer who ensures the hiring bar stays consistent across the organization, with veto power over the hiring decision.</details>
...
2. What is unique about Flipkart's interview process compared to other product-based Indian companies?
   ...
   <details><summary>Answer&lt;/summary&gt;**B)** Flipkart's machine coding round requires building a working mini-app (e.g., BookMyShow clone) in 90 minutes â€” testing production thinking, not just algorithms.</details>
...
3. Service-based companies primarily test which area in their initial screening?
   ...
   <details><summary>Answer&lt;/summary&gt;**B)** Aptitude and basic programming â€” service companies hire in bulk and use quantitative aptitude (RS Aggarwal) and CS fundamentals as the primary filter.</details>
