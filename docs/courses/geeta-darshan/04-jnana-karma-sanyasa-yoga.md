...
```mermaid
flowchart TB
    A["Aaj ka karm"] --> B{"Yajna ka prakar kya hai?"}
    B -->|"System ko wapas; jo khaaya use lautana"| D["Deva-yajna; seva aur aabhar"]
    B -->|"Gyan ka sangrah aur baantna"| BR["Brahma-yajna; seekhna aur sikhana"]
    B -->|"Parivaar aur vansh ki seva"| P["Pitri-yajna; roots aur parampara"]
    B -->|"Aane wale ki seva"| AT["Atithi-yajna; swagat aur madad"]
    D --> J["Jagruti flag; karm aur sakshi dono"]
    BR --> J
    P --> J
    AT --> J
    J --> K["Sakshi ki nazar; kaam karo aur karte dekho"]
    style J fill:#4446e8,color:#fff
    style K fill:#1a1b23,color:#fff
```
