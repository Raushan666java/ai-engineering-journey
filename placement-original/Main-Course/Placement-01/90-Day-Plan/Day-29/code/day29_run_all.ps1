# PowerShell runner for Day 29 mock test demos
Set-StrictMode -Version Latest
$ErrorActionPreference = 'Stop'
Write-Host "Compiling all Java files in Day 29 code folder..."
...
Write-Host "Day 29 mock test run completed. Outputs and compile logs are in this folder."