...
**Q10:** 7 cycle: 7Â¹→7, 7Â²→9, 7Â³→3, 7â´→1 (length 4). 343 mod 4 = 3. Unit digit = 3.
...
**Q23:** For 2Ã—2 matrix, sum of eigenvalues = trace = 5, product = determinant = 6. Solving Î»â‚+Î»â‚‚=5, Î»â‚Î»â‚‚=6 → Î»=2,3.
