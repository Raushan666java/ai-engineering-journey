...
<a href="../../../assets/images/lessons/data-structures/04-doubly-linked-list/hero.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/data-structures/04-doubly-linked-list/hero.svg" alt="Chapter Banner: Chapter 4: Doubly Linked List and Circular Linked List" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/data-structures/04-doubly-linked-list/handwritten-notes.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/data-structures/04-doubly-linked-list/handwritten-notes.svg" alt="Handwritten Notes: Chapter 4: Doubly Linked List and Circular Linked List" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/data-structures/04-doubly-linked-list/sticky-notes.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/data-structures/04-doubly-linked-list/sticky-notes.svg" alt="Sticky Notes: Chapter 4: Doubly Linked List and Circular Linked List" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/data-structures/04-doubly-linked-list/visual-explanation.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/data-structures/04-doubly-linked-list/visual-explanation.svg" alt="Visual Explanation: Chapter 4: Doubly Linked List and Circular Linked List" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/data-structures/04-doubly-linked-list/architecture.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/data-structures/04-doubly-linked-list/architecture.svg" alt="Architecture: Chapter 4: Doubly Linked List and Circular Linked List" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/data-structures/04-doubly-linked-list/workflow.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/data-structures/04-doubly-linked-list/workflow.svg" alt="Workflow: Chapter 4: Doubly Linked List and Circular Linked List" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/data-structures/04-doubly-linked-list/mindmap.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/data-structures/04-doubly-linked-list/mindmap.svg" alt="Mind Map: Chapter 4: Doubly Linked List and Circular Linked List" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/data-structures/04-doubly-linked-list/comparison.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/data-structures/04-doubly-linked-list/comparison.svg" alt="Comparison: Chapter 4: Doubly Linked List and Circular Linked List" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/data-structures/04-doubly-linked-list/cheatsheet.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/data-structures/04-doubly-linked-list/cheatsheet.svg" alt="Cheat Sheet: Chapter 4: Doubly Linked List and Circular Linked List" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/data-structures/04-doubly-linked-list/interview-quiz.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/data-structures/04-doubly-linked-list/interview-quiz.svg" alt="Quiz Card: Chapter 4: Doubly Linked List and Circular Linked List" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/data-structures/04-doubly-linked-list/social-card.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/data-structures/04-doubly-linked-list/social-card.svg" alt="Social Card: Chapter 4: Doubly Linked List and Circular Linked List" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
</div>
<!-- End Image Gallery -->
