...
<a href="../../../assets/images/lessons/discrete-mathematics/08-functions/hero.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/discrete-mathematics/08-functions/hero.svg" alt="Chapter Banner: Chapter 8: Functions" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/discrete-mathematics/08-functions/handwritten-notes.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/discrete-mathematics/08-functions/handwritten-notes.svg" alt="Handwritten Notes: Chapter 8: Functions" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/discrete-mathematics/08-functions/sticky-notes.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/discrete-mathematics/08-functions/sticky-notes.svg" alt="Sticky Notes: Chapter 8: Functions" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/discrete-mathematics/08-functions/visual-explanation.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/discrete-mathematics/08-functions/visual-explanation.svg" alt="Visual Explanation: Chapter 8: Functions" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/discrete-mathematics/08-functions/architecture.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/discrete-mathematics/08-functions/architecture.svg" alt="Architecture: Chapter 8: Functions" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/discrete-mathematics/08-functions/workflow.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/discrete-mathematics/08-functions/workflow.svg" alt="Workflow: Chapter 8: Functions" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/discrete-mathematics/08-functions/mindmap.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/discrete-mathematics/08-functions/mindmap.svg" alt="Mind Map: Chapter 8: Functions" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/discrete-mathematics/08-functions/comparison.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/discrete-mathematics/08-functions/comparison.svg" alt="Comparison: Chapter 8: Functions" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/discrete-mathematics/08-functions/cheatsheet.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/discrete-mathematics/08-functions/cheatsheet.svg" alt="Cheat Sheet: Chapter 8: Functions" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/discrete-mathematics/08-functions/interview-quiz.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/discrete-mathematics/08-functions/interview-quiz.svg" alt="Quiz Card: Chapter 8: Functions" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/discrete-mathematics/08-functions/social-card.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/discrete-mathematics/08-functions/social-card.svg" alt="Social Card: Chapter 8: Functions" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
</div>
<!-- End Image Gallery -->
