# PowerShell runner for Day 32 tree basics demos
Set-StrictMode -Version Latest
$ErrorActionPreference = 'Stop'
Write-Host "Compiling Day 32 Java files..."
...
Write-Host "Day 32 demo run completed. Outputs and compile logs are in this folder."