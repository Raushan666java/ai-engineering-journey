...
| Aspect | Stack | Heap |
|--------|-------|------|
| **Size** | Small (1â€“8 MB default per thread on Linux/Windows) | Large (up to virtual address space â€” GB on 64-bit) |
| **Speed** | Fast â€” single instruction to adjust stack pointer (~ns) | Slow â€” freelist search, possible syscall (~Î¼s) |
...
| `p = malloc(1000)` â†’ p | Heap | 0x1000100â€“0x10004e7 | 1008 bytes (8 header + 1000 data) |
...
|------|------|------------|------|
| 0 | â€” | [FREE: 0x1000â€“0x1FFF (4 KB available)] | Empty heap |
...
| **Valgrind memcheck** | Runs binary on synthetic CPU, checks every access | Very high â€” 2â€“20x slowdown |
