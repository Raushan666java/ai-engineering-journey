...
<a href="../../../assets/images/lessons/loop-engineering/ch03-human-in-the-loop/hero.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/loop-engineering/ch03-human-in-the-loop/hero.svg" alt="Chapter Banner: Chapter 3: Human-in-the-Loop" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/loop-engineering/ch03-human-in-the-loop/handwritten-notes.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/loop-engineering/ch03-human-in-the-loop/handwritten-notes.svg" alt="Handwritten Notes: Chapter 3: Human-in-the-Loop" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/loop-engineering/ch03-human-in-the-loop/sticky-notes.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/loop-engineering/ch03-human-in-the-loop/sticky-notes.svg" alt="Sticky Notes: Chapter 3: Human-in-the-Loop" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/loop-engineering/ch03-human-in-the-loop/visual-explanation.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/loop-engineering/ch03-human-in-the-loop/visual-explanation.svg" alt="Visual Explanation: Chapter 3: Human-in-the-Loop" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/loop-engineering/ch03-human-in-the-loop/architecture.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/loop-engineering/ch03-human-in-the-loop/architecture.svg" alt="Architecture: Chapter 3: Human-in-the-Loop" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/loop-engineering/ch03-human-in-the-loop/workflow.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/loop-engineering/ch03-human-in-the-loop/workflow.svg" alt="Workflow: Chapter 3: Human-in-the-Loop" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/loop-engineering/ch03-human-in-the-loop/mindmap.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/loop-engineering/ch03-human-in-the-loop/mindmap.svg" alt="Mind Map: Chapter 3: Human-in-the-Loop" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/loop-engineering/ch03-human-in-the-loop/comparison.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/loop-engineering/ch03-human-in-the-loop/comparison.svg" alt="Comparison: Chapter 3: Human-in-the-Loop" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/loop-engineering/ch03-human-in-the-loop/cheatsheet.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/loop-engineering/ch03-human-in-the-loop/cheatsheet.svg" alt="Cheat Sheet: Chapter 3: Human-in-the-Loop" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/loop-engineering/ch03-human-in-the-loop/interview-quiz.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/loop-engineering/ch03-human-in-the-loop/interview-quiz.svg" alt="Quiz Card: Chapter 3: Human-in-the-Loop" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/loop-engineering/ch03-human-in-the-loop/social-card.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/loop-engineering/ch03-human-in-the-loop/social-card.svg" alt="Social Card: Chapter 3: Human-in-the-Loop" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
</div>
<!-- End Image Gallery -->
