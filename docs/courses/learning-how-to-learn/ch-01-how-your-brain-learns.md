...
**Answer:** Cognitive Load Theory (CLT), developed by John Sweller in the 1980s, describes how the limited capacity of working memory constrains learning. Learning is effective only when instructional design respects these limits.
