...
Understand the security landscape for AI systems including prompt injection, content filtering, guardrails frameworks, and compliance. Essential for building safe and trustworthy AI applications.

## Sub-Chapters

| # | Sub-Chapter | Topics | Q&A |
|---|-------------|--------|-----|
| 01 | [Threat Landscape](01-threat-landscape.md) | prompt injection, data poisoning, model extraction, adversarial | 10 |
| 02 | [Prompt Injection Defense](02-prompt-injection-defense.md) | input sanitization, delimiters, instruction defense, perplexity | 10 |
| 03 | [Content Filtering](03-content-filtering.md) | toxicity, PII, bias, topical guardrails, moderation APIs | 10 |
...
[MLOps & Production AI](../16-mlops-production/index.md). Understanding of production AI deployment and security fundamentals is recommended.
