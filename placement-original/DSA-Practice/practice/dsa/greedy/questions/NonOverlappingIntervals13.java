...
public class NonOverlappingIntervals13 {
    ...
    // Method 3: Sort by start time (less optimal)
    ...
    public static void main(String[] args) {
        ...
        int[][] intervals4 = {{1, 2}};
        System.out.println("Test 4: " + solution.eraseOverlapIntervals(intervals4)); // Expected: 0

        // Test Case 5: Empty array
        int[][] intervals5 = {};
        System.out.println("Test 5: " + solution.eraseOverlapIntervals(intervals5)); // Expected: 0
    }
}