# PowerShell runner for Day 36 Fenwick (Binary Indexed Tree)
Set-StrictMode -Version Latest
$ErrorActionPreference = 'Stop'
Write-Host "Compiling Day 36 Java files..."
...
Write-Host "Day 36 demo run completed. Outputs and compile logs are in this folder."