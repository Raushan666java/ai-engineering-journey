...
<a href="../../../assets/images/lessons/web-development/04-js-dom/hero.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/web-development/04-js-dom/hero.svg" alt="Chapter Banner: Chapter 4 → JavaScript and the DOM" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/web-development/04-js-dom/handwritten-notes.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/web-development/04-js-dom/handwritten-notes.svg" alt="Handwritten Notes: Chapter 4 → JavaScript and the DOM" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/web-development/04-js-dom/sticky-notes.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/web-development/04-js-dom/sticky-notes.svg" alt="Sticky Notes: Chapter 4 → JavaScript and the DOM" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/web-development/04-js-dom/visual-explanation.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/web-development/04-js-dom/visual-explanation.svg" alt="Visual Explanation: Chapter 4 → JavaScript and the DOM" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/web-development/04-js-dom/architecture.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/web-development/04-js-dom/architecture.svg" alt="Architecture: Chapter 4 → JavaScript and the DOM" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/web-development/04-js-dom/workflow.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/web-development/04-js-dom/workflow.svg" alt="Workflow: Chapter 4 → JavaScript and the DOM" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/web-development/04-js-dom/mindmap.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/web-development/04-js-dom/mindmap.svg" alt="Mind Map: Chapter 4 → JavaScript and the DOM" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/web-development/04-js-dom/comparison.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/web-development/04-js-dom/comparison.svg" alt="Comparison: Chapter 4 → JavaScript and the DOM" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/web-development/04-js-dom/cheatsheet.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/web-development/04-js-dom/cheatsheet.svg" alt="Cheat Sheet: Chapter 4 → JavaScript and the DOM" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/web-development/04-js-dom/interview-quiz.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/web-development/04-js-dom/interview-quiz.svg" alt="Quiz Card: Chapter 4 → JavaScript and the DOM" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/web-development/04-js-dom/social-card.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/web-development/04-js-dom/social-card.svg" alt="Social Card: Chapter 4 → JavaScript and the DOM" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
</div>
<!-- End Image Gallery -->
