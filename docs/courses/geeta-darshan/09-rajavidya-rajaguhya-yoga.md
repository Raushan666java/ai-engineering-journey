...
```mermaid
flowchart TB
    A["Teen marg; kaun sa tumhara hai"] --> B{"Swabhaav kaisa hai?"}
    B -->|"Kaam se jeeta hai"| C["Karm-marg; khel ki drishti"]
    B -->|"Sawaal se jeeta hai"| D["Gyan-marg; anubav ki pyaas"]
    B -->|"Mann se jeeta hai"| E["Bhakti-marg; samarpan ka saahas"]
    C --> F["Teeno ek hi dwar par milte hain"]
    D --> F
    E --> F
    F --> G["Prem; chhota marg; gehri khaai"]
    G --> H["Ego girta hai; aatma khulti hai"]
    H --> I["Ananya; doosra nahin; sirf ek"]
    I --> J["Samarpan; haar nahin; jeet"]
