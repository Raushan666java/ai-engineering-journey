# PowerShell runner for Day 41 Number Theory basics
Set-StrictMode -Version Latest
$ErrorActionPreference = 'Stop'
Write-Host "Compiling Day 41 Java files..."
...
Write-Host "Day 41 demo run completed. Outputs and compile logs are in this folder."