# PowerShell runner for Day 33 Heaps & Priority Queue demos
Set-StrictMode -Version Latest
$ErrorActionPreference = 'Stop'
Write-Host "Compiling Day 33 Java files..."
...
Write-Host "Day 33 demo run completed. Outputs and compile logs are in this folder."