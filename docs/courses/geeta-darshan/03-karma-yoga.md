...
```mermaid
flowchart TB
    A["Arjuna ka sawal: gyan ya karm"] --> B["Krishna: do marg nahin; ek hi marg"]
    B --> C["3.5: koi karm ke bina nahin reh sakta"]
    C --> D["Karm ka chakra: yagna; dena"]
    D --> E["3.21: shreshth ka karm; pramaan"]
    E --> F["3.27: prakriti ke gun karte hain; ahamkar ka bhram"]
    F --> G["Aasakti bandhan hai; karm nahin"]
    G --> H["Karm yog: poornata; jagrukta; aazaadi"]
    H --> I["3.35: swadharma; apna beej"]
