...
const config: Config = {
  ...
  stylesheets: [
    {href: 'https://fonts.googleapis.com/css2?family=Source+Sans+Pro:wght@400;600;700;800&family=Source+Code+Pro:wght@400;500;600&display=swap', type: 'text/css'},
  ],
  future: {v4: true},
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      style: 'dark',
      items: [
        {type: 'docSidebar', sidebarId: 'placementSidebar', position: 'left', label: 'Placement Course'},
        {href: 'https://github.com/Raushan666java/ai-engineering-journey', label: 'GitHub', position: 'right'},
      ],
    },
    footer: {
      style: 'dark',
      ...
      copyright: `Copyright ${new Date().getFullYear()} AI Engineering Journey.`,
    },
    prism: {
