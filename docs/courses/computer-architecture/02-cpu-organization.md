...
<a href="../../../assets/images/lessons/computer-architecture/02-cpu-organization/hero.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/computer-architecture/02-cpu-organization/hero.svg" alt="Chapter Banner: CPU Organization" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/computer-architecture/02-cpu-organization/handwritten-notes.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/computer-architecture/02-cpu-organization/handwritten-notes.svg" alt="Handwritten Notes: CPU Organization" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/computer-architecture/02-cpu-organization/sticky-notes.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/computer-architecture/02-cpu-organization/sticky-notes.svg" alt="Sticky Notes: CPU Organization" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/computer-architecture/02-cpu-organization/visual-explanation.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/computer-architecture/02-cpu-organization/visual-explanation.svg" alt="Visual Explanation: CPU Organization" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/computer-architecture/02-cpu-organization/architecture.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/computer-architecture/02-cpu-organization/architecture.svg" alt="Architecture: CPU Organization" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/computer-architecture/02-cpu-organization/workflow.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/computer-architecture/02-cpu-organization/workflow.svg" alt="Workflow: CPU Organization" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/computer-architecture/02-cpu-organization/mindmap.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/computer-architecture/02-cpu-organization/mindmap.svg" alt="Mind Map: CPU Organization" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/computer-architecture/02-cpu-organization/comparison.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/computer-architecture/02-cpu-organization/comparison.svg" alt="Comparison: CPU Organization" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/computer-architecture/02-cpu-organization/cheatsheet.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/computer-architecture/02-cpu-organization/cheatsheet.svg" alt="Cheat Sheet: CPU Organization" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/computer-architecture/02-cpu-organization/interview-quiz.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/computer-architecture/02-cpu-organization/interview-quiz.svg" alt="Quiz Card: CPU Organization" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/computer-architecture/02-cpu-organization/social-card.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/computer-architecture/02-cpu-organization/social-card.svg" alt="Social Card: CPU Organization" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
</div>
<!-- End Image Gallery -->
