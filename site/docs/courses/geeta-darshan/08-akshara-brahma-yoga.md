---
id: 08-akshara-brahma-yoga
slug: /geeta-darshan/08-akshara-brahma-yoga
title: "अध्याय ८: अक्षर ब्रह्म योग — Maut ka sawaal nahin, jeevan ka pal hai"
sidebar_label: "अध्याय ८: अक्षर ब्रह्म योग — Maut ka sawaal nahin, jeevan ka pal hai"
sidebar_position: 9
---
...
```mermaid
flowchart TB
    A["Mritvu ka sawaal; asli sawaal jeevan ka hai"] --> B{"Antim khayaal kaise banta hai?"}
    B -->|"Roz ki aadat se"| C["Aaj ka khayaal; wahi kal ka swabhaav"]
    C --> D["Antim khayaal; koi program nahin; hisaab hai"]
    D --> E["Taiyaari mrityu ke liye nahin; jeevan ke liye"]
    B -->|"Moun se"| F["Om; vichaaron ke neeche ki dhwani"]
    F --> G["Sakshi; jo sunta hai woh asli hai"]
    G --> H["Har pal antakal; aaj ko jeena seekho"]
    H --> I["Bheetar ka aaina; mrityu ka darr girta hai"]
    style G fill:#4446e8,color:#fff
    style I fill:#1a1b23,color:#fff
```
