...
1. Implement accuracy, precision, recall, and F1 from scratch. Test with y_true = [0,1,0,1,2,2,0,1] and y_pred = [0,1,0,0,2,1,0,1].
...
5. Build a metric recommender system. Given a task description, suggest primary and secondary metrics, and warn about metric limitations.
