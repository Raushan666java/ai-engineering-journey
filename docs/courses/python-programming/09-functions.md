...
<a href="../../../assets/images/lessons/python-programming/09-functions/hero.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/python-programming/09-functions/hero.svg" alt="Chapter Banner: Chapter 9: Functions" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/python-programming/09-functions/handwritten-notes.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/python-programming/09-functions/handwritten-notes.svg" alt="Handwritten Notes: Chapter 9: Functions" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/python-programming/09-functions/sticky-notes.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/python-programming/09-functions/sticky-notes.svg" alt="Sticky Notes: Chapter 9: Functions" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/python-programming/09-functions/visual-explanation.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/python-programming/09-functions/visual-explanation.svg" alt="Visual Explanation: Chapter 9: Functions" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/python-programming/09-functions/architecture.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/python-programming/09-functions/architecture.svg" alt="Architecture: Chapter 9: Functions" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/python-programming/09-functions/workflow.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/python-programming/09-functions/workflow.svg" alt="Workflow: Chapter 9: Functions" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/python-programming/09-functions/mindmap.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/python-programming/09-functions/mindmap.svg" alt="Mind Map: Chapter 9: Functions" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/python-programming/09-functions/comparison.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/python-programming/09-functions/comparison.svg" alt="Comparison: Chapter 9: Functions" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/python-programming/09-functions/cheatsheet.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/python-programming/09-functions/cheatsheet.svg" alt="Cheat Sheet: Chapter 9: Functions" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/python-programming/09-functions/interview-quiz.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/python-programming/09-functions/interview-quiz.svg" alt="Quiz Card: Chapter 9: Functions" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/python-programming/09-functions/social-card.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/python-programming/09-functions/social-card.svg" alt="Social Card: Chapter 9: Functions" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
</div>
<!-- End Image Gallery -->
