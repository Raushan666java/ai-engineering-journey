...
<a href="../../../assets/images/lessons/loop-engineering/ch07-loop-safety/hero.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/loop-engineering/ch07-loop-safety/hero.svg" alt="Chapter Banner: Chapter 7: Loop Safety" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/loop-engineering/ch07-loop-safety/handwritten-notes.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/loop-engineering/ch07-loop-safety/handwritten-notes.svg" alt="Handwritten Notes: Chapter 7: Loop Safety" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/loop-engineering/ch07-loop-safety/sticky-notes.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/loop-engineering/ch07-loop-safety/sticky-notes.svg" alt="Sticky Notes: Chapter 7: Loop Safety" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/loop-engineering/ch07-loop-safety/visual-explanation.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/loop-engineering/ch07-loop-safety/visual-explanation.svg" alt="Visual Explanation: Chapter 7: Loop Safety" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/loop-engineering/ch07-loop-safety/architecture.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/loop-engineering/ch07-loop-safety/architecture.svg" alt="Architecture: Chapter 7: Loop Safety" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/loop-engineering/ch07-loop-safety/workflow.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/loop-engineering/ch07-loop-safety/workflow.svg" alt="Workflow: Chapter 7: Loop Safety" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/loop-engineering/ch07-loop-safety/mindmap.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/loop-engineering/ch07-loop-safety/mindmap.svg" alt="Mind Map: Chapter 7: Loop Safety" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/loop-engineering/ch07-loop-safety/comparison.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/loop-engineering/ch07-loop-safety/comparison.svg" alt="Comparison: Chapter 7: Loop Safety" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/loop-engineering/ch07-loop-safety/cheatsheet.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/loop-engineering/ch07-loop-safety/cheatsheet.svg" alt="Cheat Sheet: Chapter 7: Loop Safety" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/loop-engineering/ch07-loop-safety/interview-quiz.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/loop-engineering/ch07-loop-safety/interview-quiz.svg" alt="Quiz Card: Chapter 7: Loop Safety" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/loop-engineering/ch07-loop-safety/social-card.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/loop-engineering/ch07-loop-safety/social-card.svg" alt="Social Card: Chapter 7: Loop Safety" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
</div>
<!-- End Image Gallery -->
