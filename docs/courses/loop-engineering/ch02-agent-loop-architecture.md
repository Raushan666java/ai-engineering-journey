...
<a href="../../../assets/images/lessons/loop-engineering/ch02-agent-loop-architecture/hero.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/loop-engineering/ch02-agent-loop-architecture/hero.svg" alt="Chapter Banner: Chapter 2: Agent Loop Architecture" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/loop-engineering/ch02-agent-loop-architecture/handwritten-notes.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/loop-engineering/ch02-agent-loop-architecture/handwritten-notes.svg" alt="Handwritten Notes: Chapter 2: Agent Loop Architecture" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/loop-engineering/ch02-agent-loop-architecture/sticky-notes.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/loop-engineering/ch02-agent-loop-architecture/sticky-notes.svg" alt="Sticky Notes: Chapter 2: Agent Loop Architecture" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/loop-engineering/ch02-agent-loop-architecture/visual-explanation.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/loop-engineering/ch02-agent-loop-architecture/visual-explanation.svg" alt="Visual Explanation: Chapter 2: Agent Loop Architecture" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/loop-engineering/ch02-agent-loop-architecture/architecture.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/loop-engineering/ch02-agent-loop-architecture/architecture.svg" alt="Architecture: Chapter 2: Agent Loop Architecture" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/loop-engineering/ch02-agent-loop-architecture/workflow.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/loop-engineering/ch02-agent-loop-architecture/workflow.svg" alt="Workflow: Chapter 2: Agent Loop Architecture" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/loop-engineering/ch02-agent-loop-architecture/mindmap.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/loop-engineering/ch02-agent-loop-architecture/mindmap.svg" alt="Mind Map: Chapter 2: Agent Loop Architecture" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/loop-engineering/ch02-agent-loop-architecture/comparison.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/loop-engineering/ch02-agent-loop-architecture/comparison.svg" alt="Comparison: Chapter 2: Agent Loop Architecture" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/loop-engineering/ch02-agent-loop-architecture/cheatsheet.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/loop-engineering/ch02-agent-loop-architecture/cheatsheet.svg" alt="Cheat Sheet: Chapter 2: Agent Loop Architecture" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/loop-engineering/ch02-agent-loop-architecture/interview-quiz.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/loop-engineering/ch02-agent-loop-architecture/interview-quiz.svg" alt="Quiz Card: Chapter 2: Agent Loop Architecture" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/loop-engineering/ch02-agent-loop-architecture/social-card.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/loop-engineering/ch02-agent-loop-architecture/social-card.svg" alt="Social Card: Chapter 2: Agent Loop Architecture" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
</div>
<!-- End Image Gallery -->
