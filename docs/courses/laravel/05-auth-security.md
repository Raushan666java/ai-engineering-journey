...
<a href="../../../assets/images/lessons/laravel/05-auth-security/hero.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/laravel/05-auth-security/hero.svg" alt="Chapter Banner: Chapter 5: Authentication, Authorization & Security" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/laravel/05-auth-security/handwritten-notes.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/laravel/05-auth-security/handwritten-notes.svg" alt="Handwritten Notes: Chapter 5: Authentication, Authorization & Security" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/laravel/05-auth-security/sticky-notes.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/laravel/05-auth-security/sticky-notes.svg" alt="Sticky Notes: Chapter 5: Authentication, Authorization & Security" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/laravel/05-auth-security/visual-explanation.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/laravel/05-auth-security/visual-explanation.svg" alt="Visual Explanation: Chapter 5: Authentication, Authorization & Security" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/laravel/05-auth-security/architecture.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/laravel/05-auth-security/architecture.svg" alt="Architecture: Chapter 5: Authentication, Authorization & Security" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/laravel/05-auth-security/workflow.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/laravel/05-auth-security/workflow.svg" alt="Workflow: Chapter 5: Authentication, Authorization & Security" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/laravel/05-auth-security/mindmap.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/laravel/05-auth-security/mindmap.svg" alt="Mind Map: Chapter 5: Authentication, Authorization & Security" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/laravel/05-auth-security/comparison.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/laravel/05-auth-security/comparison.svg" alt="Comparison: Chapter 5: Authentication, Authorization & Security" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/laravel/05-auth-security/cheatsheet.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/laravel/05-auth-security/cheatsheet.svg" alt="Cheat Sheet: Chapter 5: Authentication, Authorization & Security" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/laravel/05-auth-security/interview-quiz.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/laravel/05-auth-security/interview-quiz.svg" alt="Quiz Card: Chapter 5: Authentication, Authorization & Security" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/laravel/05-auth-security/social-card.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/laravel/05-auth-security/social-card.svg" alt="Social Card: Chapter 5: Authentication, Authorization & Security" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
</div>
<!-- End Image Gallery -->
