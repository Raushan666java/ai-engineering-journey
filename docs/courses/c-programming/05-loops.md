...
<a href="../../../assets/images/lessons/c-programming/05-loops/hero.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/c-programming/05-loops/hero.svg" alt="Chapter Banner: Chapter 5: Loops (Comprehensive)" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/c-programming/05-loops/handwritten-notes.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/c-programming/05-loops/handwritten-notes.svg" alt="Handwritten Notes: Chapter 5: Loops (Comprehensive)" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/c-programming/05-loops/sticky-notes.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/c-programming/05-loops/sticky-notes.svg" alt="Sticky Notes: Chapter 5: Loops (Comprehensive)" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/c-programming/05-loops/visual-explanation.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/c-programming/05-loops/visual-explanation.svg" alt="Visual Explanation: Chapter 5: Loops (Comprehensive)" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/c-programming/05-loops/architecture.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/c-programming/05-loops/architecture.svg" alt="Architecture: Chapter 5: Loops (Comprehensive)" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/c-programming/05-loops/workflow.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/c-programming/05-loops/workflow.svg" alt="Workflow: Chapter 5: Loops (Comprehensive)" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/c-programming/05-loops/mindmap.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/c-programming/05-loops/mindmap.svg" alt="Mind Map: Chapter 5: Loops (Comprehensive)" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/c-programming/05-loops/comparison.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/c-programming/05-loops/comparison.svg" alt="Comparison: Chapter 5: Loops (Comprehensive)" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/c-programming/05-loops/cheatsheet.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/c-programming/05-loops/cheatsheet.svg" alt="Cheat Sheet: Chapter 5: Loops (Comprehensive)" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/c-programming/05-loops/interview-quiz.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/c-programming/05-loops/interview-quiz.svg" alt="Quiz Card: Chapter 5: Loops (Comprehensive)" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/c-programming/05-loops/social-card.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/c-programming/05-loops/social-card.svg" alt="Social Card: Chapter 5: Loops (Comprehensive)" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
</div>
<!-- End Image Gallery -->
