...
**Easy** — Set up a simple A/B test between two versions of a sentiment analysis model using 20% traffic split. Generate synthetic results and determine the winner.
...
> **Previous**: [09-model-deployment.md](09-model-deployment.md) | **Next**: [index.md](index.md)
