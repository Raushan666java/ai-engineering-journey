...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_components.header, {
      ...
      }), "/.test(p.lhs) &&\n(p.rhs.length === 1 && /^[a-z]", (0,jsx_runtime.jsx)(_components.span, {
        className: "katex-error",
        title: "ParseError: KaTeX parse error: Expected 'EOF', got '&' at position 49: …s.length === 2 &̲& /^[A-Z][a-z]",
        style: {
          color: "#cc0000"
        },
        children: "/.test(p.rhs) ||\n            p.rhs.length === 2 && /^[A-Z][a-z]"
