...
Write-Host "Compiling Day 27 Java files..."
...
$demos = @("ThreadsBasics","SyncDemo","ExecutorDemo","ConcurrentCollectionsDemo")
foreach ($d in $demos) {
...
Write-Host "Day 27 demo run completed. Outputs and compile logs are in this folder."
