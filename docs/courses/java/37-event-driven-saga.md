...
<a href="../../../assets/images/lessons/java/37-event-driven-saga/hero.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/java/37-event-driven-saga/hero.svg" alt="Chapter Banner: Event-Driven Architecture & SAGA" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/java/37-event-driven-saga/handwritten-notes.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/java/37-event-driven-saga/handwritten-notes.svg" alt="Handwritten Notes: Event-Driven Architecture & SAGA" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/java/37-event-driven-saga/sticky-notes.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/java/37-event-driven-saga/sticky-notes.svg" alt="Sticky Notes: Event-Driven Architecture & SAGA" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/java/37-event-driven-saga/visual-explanation.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/java/37-event-driven-saga/visual-explanation.svg" alt="Visual Explanation: Event-Driven Architecture & SAGA" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/java/37-event-driven-saga/architecture.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/java/37-event-driven-saga/architecture.svg" alt="Architecture: Event-Driven Architecture & SAGA" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/java/37-event-driven-saga/workflow.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/java/37-event-driven-saga/workflow.svg" alt="Workflow: Event-Driven Architecture & SAGA" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/java/37-event-driven-saga/mindmap.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/java/37-event-driven-saga/mindmap.svg" alt="Mind Map: Event-Driven Architecture & SAGA" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/java/37-event-driven-saga/comparison.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/java/37-event-driven-saga/comparison.svg" alt="Comparison: Event-Driven Architecture & SAGA" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/java/37-event-driven-saga/cheatsheet.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/java/37-event-driven-saga/cheatsheet.svg" alt="Cheat Sheet: Event-Driven Architecture & SAGA" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/java/37-event-driven-saga/interview-quiz.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/java/37-event-driven-saga/interview-quiz.svg" alt="Quiz Card: Event-Driven Architecture & SAGA" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/java/37-event-driven-saga/social-card.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/java/37-event-driven-saga/social-card.svg" alt="Social Card: Event-Driven Architecture & SAGA" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
</div>
<!-- End Image Gallery -->
