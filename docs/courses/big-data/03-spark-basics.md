...
<a href="../../../assets/images/lessons/big-data/03-spark-basics/hero.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/big-data/03-spark-basics/hero.svg" alt="Chapter Banner: Chapter 3: Apache Spark Basics" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/big-data/03-spark-basics/handwritten-notes.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/big-data/03-spark-basics/handwritten-notes.svg" alt="Handwritten Notes: Chapter 3: Apache Spark Basics" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/big-data/03-spark-basics/sticky-notes.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/big-data/03-spark-basics/sticky-notes.svg" alt="Sticky Notes: Chapter 3: Apache Spark Basics" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/big-data/03-spark-basics/visual-explanation.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/big-data/03-spark-basics/visual-explanation.svg" alt="Visual Explanation: Chapter 3: Apache Spark Basics" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/big-data/03-spark-basics/architecture.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/big-data/03-spark-basics/architecture.svg" alt="Architecture: Chapter 3: Apache Spark Basics" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/big-data/03-spark-basics/workflow.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/big-data/03-spark-basics/workflow.svg" alt="Workflow: Chapter 3: Apache Spark Basics" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/big-data/03-spark-basics/mindmap.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/big-data/03-spark-basics/mindmap.svg" alt="Mind Map: Chapter 3: Apache Spark Basics" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/big-data/03-spark-basics/comparison.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/big-data/03-spark-basics/comparison.svg" alt="Comparison: Chapter 3: Apache Spark Basics" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/big-data/03-spark-basics/cheatsheet.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/big-data/03-spark-basics/cheatsheet.svg" alt="Cheat Sheet: Chapter 3: Apache Spark Basics" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/big-data/03-spark-basics/interview-quiz.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/big-data/03-spark-basics/interview-quiz.svg" alt="Quiz Card: Chapter 3: Apache Spark Basics" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/big-data/03-spark-basics/social-card.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/big-data/03-spark-basics/social-card.svg" alt="Social Card: Chapter 3: Apache Spark Basics" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
</div>
<!-- End Image Gallery -->
