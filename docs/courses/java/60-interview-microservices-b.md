...
<a href="../../../assets/images/lessons/java/60-interview-microservices-b/hero.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/java/60-interview-microservices-b/hero.svg" alt="Chapter Banner: ── Multi-stage Dockerfile for a Spring Boot microservice ──" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/java/60-interview-microservices-b/handwritten-notes.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/java/60-interview-microservices-b/handwritten-notes.svg" alt="Handwritten Notes: ── Multi-stage Dockerfile for a Spring Boot microservice ──" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/java/60-interview-microservices-b/sticky-notes.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/java/60-interview-microservices-b/sticky-notes.svg" alt="Sticky Notes: ── Multi-stage Dockerfile for a Spring Boot microservice ──" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/java/60-interview-microservices-b/visual-explanation.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/java/60-interview-microservices-b/visual-explanation.svg" alt="Visual Explanation: ── Multi-stage Dockerfile for a Spring Boot microservice ──" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/java/60-interview-microservices-b/architecture.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/java/60-interview-microservices-b/architecture.svg" alt="Architecture: ── Multi-stage Dockerfile for a Spring Boot microservice ──" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/java/60-interview-microservices-b/workflow.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/java/60-interview-microservices-b/workflow.svg" alt="Workflow: ── Multi-stage Dockerfile for a Spring Boot microservice ──" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/java/60-interview-microservices-b/mindmap.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/java/60-interview-microservices-b/mindmap.svg" alt="Mind Map: ── Multi-stage Dockerfile for a Spring Boot microservice ──" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/java/60-interview-microservices-b/comparison.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/java/60-interview-microservices-b/comparison.svg" alt="Comparison: ── Multi-stage Dockerfile for a Spring Boot microservice ──" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/java/60-interview-microservices-b/cheatsheet.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/java/60-interview-microservices-b/cheatsheet.svg" alt="Cheat Sheet: ── Multi-stage Dockerfile for a Spring Boot microservice ──" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/java/60-interview-microservices-b/interview-quiz.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/java/60-interview-microservices-b/interview-quiz.svg" alt="Quiz Card: ── Multi-stage Dockerfile for a Spring Boot microservice ──" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
<a href="../../../assets/images/lessons/java/60-interview-microservices-b/social-card.svg" target="_blank" rel="noopener">
  <img src="../../../assets/images/lessons/java/60-interview-microservices-b/social-card.svg" alt="Social Card: ── Multi-stage Dockerfile for a Spring Boot microservice ──" width="18%" style="margin:2px;border:1px solid #e2e8f0;border-radius:6px;">
</a>
</div>
<!-- End Image Gallery -->
